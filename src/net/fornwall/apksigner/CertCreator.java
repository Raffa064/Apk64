...
public class CertCreator {
	...
	public static class DistinguishedNameValues {/*extends LinkedHashMap<ASN1ObjectIdentifier, String> {*/
		LinkedHashMap<ASN1ObjectIdentifier, String> hash = new LinkedHashMap<>();
		...
		public String put(ASN1ObjectIdentifier oid, String value) {
			if (value != null && value.equals(""))
				value = null;
			if (hash.containsKey(oid))
				hash.put(oid, value); // preserve original ordering
			else {
				hash.put(oid, value);
		...
		public X509Principal getPrincipal() {
			...
			for (Map.Entry<ASN1ObjectIdentifier, String> entry : hash.entrySet()) {
